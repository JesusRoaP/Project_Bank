...
<br>
<div class="pb-info" style="width: 90%">
	<ul>
		...
		<li>Utiliza el siguiente shortcode para administrar el Banco de Proyectos desde el Frontend: <input id="shortcode-3" type="text" value="[project_bank_admin]"><button class="button" onclick="copyToClipboard('#shortcode-3')">Copiar Shortcode</button><span class="copy" style="display: none">Copiado!</span>
			<ul>
				<li>Esta página debe tener como página superior la página principal del plugin.</li>
